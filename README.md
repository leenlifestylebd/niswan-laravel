...
**পাবলিক সাইট**
- হোমপেজ: Hero স্লাইডার + প্রোডাক্ট গ্রিড (DB থেকে, `active` + `sort_order`)
- প্রোডাক্ট পেজ `/product/{slug}`: মার্কি গ্যালারি, অটো-স্লাইডার, ভ্যারিয়েন্ট, সাইজ
- অর্ডার ফর্ম: ভ্যারিয়েন্ট/সাইজ/পরিমাণ/এলাকা, ডেলিভারি চার্জ হিসাব, **ফোন ১১-ডিজিট যাচাই**
  (`^01\d{9}$`, `+880`/`880` প্রিফিক্স গ্রহণযোগ্য) — client ও server দুই জায়গায়
- WhatsApp-এ অর্ডার বাটন, রিভিউ/ফিডব্যাক গ্যালারি
- SEO: JSON-LD (Store / Product), OpenGraph, canonical
...
- সেটিংস: ব্র্যান্ড, রঙ, ডেলিভারি চার্জ, **এনক্রিপ্টেড সিক্রেট টোকেন**
...
resources/views/
  layouts/{app,admin}        পাবলিক ও অ্যাডমিন লেআউট (থিম রঙ CSS variable)
  partials/                  hero, product-grid, product-detail, order-form, feedback ...
